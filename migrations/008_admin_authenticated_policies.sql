...
-- 2. Drop existing admin policies if they exist (for idempotency)
...
-- 3. Authenticated Admin RLS Policies for Hotel Content & Enquiries
...
-- 4. Storage Bucket Policies for Authenticated Admin Uploads / Deletions
